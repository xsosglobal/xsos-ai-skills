...
ln -sfn "$(pwd)/xsos-wbs-author" ~/.claude/skills/xsos-wbs-author
...
ln -sfn "$(pwd)/xsos-wbs-author" ~/.codex/skills/xsos-wbs-author
...
# ln -sfn "$(pwd)/xsos-wbs-author" ~/.hermes/skills/xsos-wbs-author
