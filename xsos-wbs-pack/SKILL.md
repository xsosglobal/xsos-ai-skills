...
8. Let the project owner have maximum authority inside their own project. Escalate only global rules or cross-module contracts.
...
3. If the work changes global platform rules or cross-module contracts, add it as `proposed` even when requested by a project owner.
...
Global rule or cross-module contract change -> status=proposed
```
